...
-- Colors
local PINK       = Color3.fromRGB(200, 30, 90)     -- Main dark pink
local PINK_LIGHT = Color3.fromRGB(255, 80, 140)
local PINK_DARK  = Color3.fromRGB(140, 15, 60)
local BG_DARK    = Color3.fromRGB(14, 5, 10)
local BG_MID     = Color3.fromRGB(22, 8, 14)
local SECTION_BG = Color3.fromRGB(18, 6, 12)
